    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            if sentence.known_mines()!=None:
                for cellvariable in sentence.known_mines():
                    self.mines.add(cellvariable)
                    if sentence in self.knowledge:
                        self.knowledge.remove(sentence)
            if sentence.known_safes()!=None:
                for cellvariable in sentence.known_safes():
                    if cellvariable not in self.moves_made:
                        self.safes.add(cellvariable)
                        if sentence in self.knowledge:
                            self.knowledge.remove(sentence)
        for sentence in self.knowledge:
            ...
            for sentence2 in self.knowledge:
                if(sentence1.cells!=sentence2.cells and len(sentence1.cells)==0 and len(sentence2.cells)==0):
                    if sentence1.cells.issubset(sentence2.cells):
                        ...
                        count=len(sentence2.cells)-len(sentence1.cells)
                        if len(cells)!=0:    
                            self.knowledge.append(Sentence(cells,count))

        for sentence in self.knowledge:
            print("sentence",sentence.cells,"count",sentence.count)

        print(self.safes,"safe move")
